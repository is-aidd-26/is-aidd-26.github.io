...
4. Не самостоятельное выполнение работ. Попадание под указанные критерии в любом объёме может служить причиной бана без
   права исправления
   работы.
    - Плагиат (работы из открытых/закрытых источников)
    - Выполнение работы третьим лицом вне зависимости от наличия финансового вознаграждения
    - Использование не процедурных инструментов генерации кода (LLM, любой ML-based способ генерации кода, любой code
      completion не основанный на правилах intelli-sense или аналогичных инструментов)
